...
import org.jetbrains.logger.utils.LogUtils;

import java.util.Objects;

import static com.intellij.codeInsight.template.postfix.templates.PostfixTemplatesUtils.showErrorHint;
...
public class LogTemplate extends StringBasedPostfixTemplate {
    ...
    public LogTemplate(@NotNull String name,
                       @NotNull String example,
                       @NotNull String level,
                       LogTemplateProvider logTemplateProvider) {
    ...
    public void expandForChooseExpression(@NotNull PsiElement expr, @NotNull Editor editor) {
        ...
        if (loggerName == null) {
            LogUtils.showErrorHint(expr.getProject(), editor);
            return;
        }
    ...
    private String getTemplateAfterParent(@NotNull PsiElement element, String localVariable) {
        return getParent(element).getText() + "\n"
                + "$" + LOGGER + "$." + level + "("
                + "\"" + localVariable + "=\" + "
                + localVariable + ");$END$";
    }
